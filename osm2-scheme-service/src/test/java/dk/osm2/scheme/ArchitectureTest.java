...
/**
 * Architecture rules for osm2-scheme-service.
 *
 * <p>R-06 is absent: scheme-service has no .client package.
 */
@AnalyzeClasses(packages = "dk.osm2.scheme", importOptions = ImportOption.DoNotIncludeTests.class)
class ArchitectureTest {
    ...
    static final ArchRule r03NoCrossServiceImports =
            SharedArchitectureRules.noCrossServiceImports(ServicePackages.SCHEME);
    ...
    static final Architectures.LayeredArchitecture r05LayeredArchitecture =
            SharedArchitectureRules.layeredArchitectureFor(ServicePackages.SCHEME);
