 ...
 * so that any Spring Boot application that includes {@code oces3-certificate-parser} on its
 * classpath will automatically have {@link Oces3CertificateParser} available as a bean without
 * requiring an explicit {@code @ComponentScan} in the consuming application.
 */
@Configuration
