...
/**
 * Architecture rules for osm2-taxable-person-portal.
 *
 * <p>R-06 is disabled: RegistrationServiceClient and SchemeServiceClient currently
 * lack {@code @CircuitBreaker} annotations. Enable after ADR-0026 compliance is
 * implemented in the portal client classes.
 */
@AnalyzeClasses(packages = "dk.osm2.taxableperson", importOptions = ImportOption.DoNotIncludeTests.class)
class ArchitectureTest {
    ...
    static final ArchRule r03NoCrossServiceImports =
            SharedArchitectureRules.noCrossServiceImports(ServicePackages.TAXABLE_PERSON_PORTAL);
    ...
    static final Architectures.LayeredArchitecture r05LayeredArchitecture =
            SharedArchitectureRules.layeredArchitectureFor(ServicePackages.TAXABLE_PERSON_PORTAL);
    ...
    @Test
    @Disabled("R-06: Enable once RegistrationServiceClient and SchemeServiceClient"
            + " methods carry @CircuitBreaker/@Retry/@TimeLimiter annotations [ADR-0026]")
    void r06ClientMethodsMustHaveResilience() {
        JavaClasses classes = new ClassFileImporter()
                .withImportOption(ImportOption.Predefined.DO_NOT_INCLUDE_TESTS)
                .importPackages(ServicePackages.TAXABLE_PERSON_PORTAL);
