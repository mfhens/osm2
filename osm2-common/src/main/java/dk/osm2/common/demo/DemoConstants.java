 ...
 *
 * <p>All seed SQL files and integration tests MUST use these constants so that
 * cross-service references remain consistent. UUID literals here match those in
 * {@code db/seed/V9001__seed_demo_data.sql} in each service module.
 *
 * <p>This class contains no Spring beans and is safe to reference from both
 * production demo seeds and test code.
 */
public final class DemoConstants {
    ...
    public static final UUID PRINCIPAL_ID =
