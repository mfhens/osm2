...
/**
 * Architecture rules for osm2-payment-service.
 *
 ...
 */
@AnalyzeClasses(packages = "dk.osm2.payment", importOptions = ImportOption.DoNotIncludeTests.class)
class ArchitectureTest {
    ...
    static final ArchRule r03NoCrossServiceImports =
            SharedArchitectureRules.noCrossServiceImports(ServicePackages.PAYMENT);
    ...
    static final Architectures.LayeredArchitecture r05LayeredArchitecture =
            SharedArchitectureRules.layeredArchitectureFor(ServicePackages.PAYMENT);
