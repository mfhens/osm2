...
VALUES
    ...
    ('rec00003-0000-0000-0000-000000000001',
     '33333333-3333-3333-3333-333333333333',
     'REGISTRATION', '2021-07-01', NULL,
     'sr000003-0000-0000-0000-000000000001',
...
INSERT INTO vat_record (id, registrant_id, record_type, period_start, period_end,
                        source_id, content_json, retain_until, created_at)
VALUES
    ('rec10001-0000-0000-0000-000000000001',
     '11111111-1111-1111-1111-111111111111',
    ...
    ('rec10002-0000-0000-0000-000000000001',
     '11111111-1111-1111-1111-111111111111',
    ...
    ('rec10003-0000-0000-0000-000000000001',
     '11111111-1111-1111-1111-111111111111',
...
INSERT INTO vat_record (id, registrant_id, record_type, period_start, period_end,
                        source_id, content_json, retain_until, created_at)
VALUES
    ('rec20001-0000-0000-0000-000000000001',
     '22222222-2222-2222-2222-222222222222',
     'RETURN', '2023-07-01', '2023-09-30',
    ...
    ('rec20002-0000-0000-0000-000000000001',
     '22222222-2222-2222-2222-222222222222',
     'RETURN', '2023-10-01', '2023-12-31',
...
INSERT INTO vat_record (id, registrant_id, record_type, period_start, period_end,
                        source_id, content_json, retain_until, created_at)
VALUES
    ('rec30001-0000-0000-0000-000000000001',
     '11111111-1111-1111-1111-111111111111',
    ...
    ('rec30002-0000-0000-0000-000000000001',
     '11111111-1111-1111-1111-111111111111',
...
VALUES
    ...
    ('log00002-0000-0000-0000-000000000001',
     'rec10001-0000-0000-0000-000000000001',
