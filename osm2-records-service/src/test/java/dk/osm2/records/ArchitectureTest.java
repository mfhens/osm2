...
/**
 * Architecture rules for osm2-records-service.
 *
 ...
 *
 * <p>R-06: add as a disabled @Test once .client classes are introduced.
 */
@AnalyzeClasses(packages = "dk.osm2.records", importOptions = ImportOption.DoNotIncludeTests.class)
class ArchitectureTest {
    ...
    static final ArchRule r03NoCrossServiceImports =
            SharedArchitectureRules.noCrossServiceImports(ServicePackages.RECORDS);
    ...
    static final Architectures.LayeredArchitecture r05LayeredArchitecture =
            SharedArchitectureRules.layeredArchitectureFor(ServicePackages.RECORDS);
