...
VALUES
    ('rl000001-0001-0000-0000-000000000001', 'aaaa0001-0000-0000-0000-000000000000',
     'DE', 500000, 19.00, 95000),
    ('rl000001-0001-0000-0000-000000000002', 'aaaa0001-0000-0000-0000-000000000000',
     'FR', 320000, 20.00, 64000),
    ('rl000001-0001-0000-0000-000000000003', 'aaaa0001-0000-0000-0000-000000000000',
...
INSERT INTO return_line (id, return_id, member_state,
                         taxable_amount_eur_cents, vat_rate_pct, vat_amount_eur_cents)
VALUES
    ('rl000002-0001-0000-0000-000000000001', 'aaaa0002-0000-0000-0000-000000000000',
     'DE', 620000, 19.00, 117800),
    ('rl000002-0001-0000-0000-000000000002', 'aaaa0002-0000-0000-0000-000000000000',
...
INSERT INTO return_line (id, return_id, member_state,
                         taxable_amount_eur_cents, vat_rate_pct, vat_amount_eur_cents)
VALUES
    ('rl000003-0001-0000-0000-000000000001', 'aaaa0003-0000-0000-0000-000000000000',
...
INSERT INTO return_line (id, return_id, member_state,
                         taxable_amount_eur_cents, vat_rate_pct, vat_amount_eur_cents)
VALUES
    ('rl000004-0001-0000-0000-000000000001', 'aaaa0004-0000-0000-0000-000000000000',
...
INSERT INTO return_line (id, return_id, member_state,
                         taxable_amount_eur_cents, vat_rate_pct, vat_amount_eur_cents)
VALUES
    ('rl000005-0001-0000-0000-000000000001', 'bbbb0001-0000-0000-0000-000000000000',
     'DK', 400000, 25.00, 100000),
    ('rl000005-0001-0000-0000-000000000002', 'bbbb0001-0000-0000-0000-000000000000',
...
INSERT INTO return_line (id, return_id, member_state,
                         taxable_amount_eur_cents, vat_rate_pct, vat_amount_eur_cents)
VALUES
    ('rl000006-0001-0000-0000-000000000001', 'cccc0001-0000-0000-0000-000000000000',
     'DE', 120000, 19.00, 22800),
    ('rl000006-0001-0000-0000-000000000002', 'cccc0001-0000-0000-0000-000000000000',
...
INSERT INTO return_line (id, return_id, member_state,
                         taxable_amount_eur_cents, vat_rate_pct, vat_amount_eur_cents)
VALUES
    ('rl000007-0001-0000-0000-000000000001', 'cccc0002-0000-0000-0000-000000000000',
